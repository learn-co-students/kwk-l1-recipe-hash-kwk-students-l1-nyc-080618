...
perfect_10_recipe = {:almond_flour => "2 cups", :gluten_freewhole_oats => "1 cup", :kosher_salt => "1/2 tea spoon", :baking_powder => "1/2 tea spoon", :baking_soda => "1/4 tea spoon", :xanthan_Gum => "1/2 tea spoon", :silvered_almonds => "1/4 cup", :mini_dark_chocolate_chips => "3/4 cups", :olive_oil => "1/2 cup", :agave => "1/4 cup"}
...
def amount_of_chocolate_chips(perfect_10_recipe)
  amount = perfect_10_recipe[:mini_dark_chocolate_chips]
  return amount
end
...
def number_ingredients(perfect_10_recipe)
  ...
  number_ingredients = ingredients.size
